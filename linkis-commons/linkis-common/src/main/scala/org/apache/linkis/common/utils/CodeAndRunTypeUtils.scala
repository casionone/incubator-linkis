...
object CodeAndRunTypeUtils {
  ...
  val CODE_TYPE_AND_RUN_TYPE_RELATION = CommonVars("linkis.codeType.runType.relation", "sql=>sql|hql|jdbc|hive|psql|fql,python=>python|py|pyspark,java=>java,scala=>scala,shell=>sh|shell")
